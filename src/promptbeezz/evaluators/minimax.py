...
class MinimaxEvaluator(BaseEvaluator):
    """Evaluator that uses a Minimax judge model."""
    ...
    def __init__(
        ...
        *,
        ...
        self._client = MinimaxLLMClient(api_key=api_key, model=model, base_url=base_url)
